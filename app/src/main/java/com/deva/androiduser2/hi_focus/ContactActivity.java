...
public class ContactActivity extends Activity {
    ...
    EditText name, email, mobile, city, state, subject;
    Button submt;
    String na, em, mob, cit, sta, sub;
    private String url = "http://hifocuscctv.com/apps/Android/contactFormConnection.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subject = (EditText) findViewById(R.id.subid);
        ...
        submt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isValidName(names)) {
                    ...
                    accessWebService();
                    Toast.makeText(getApplicationContext(), "Thanks for contacting us. Our team will talk to you soon.", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(ContactActivity.this, HIFOCUS.class);
                    startActivity(i);
                }
    ...
    public void accessWebService() {
        ...
        task.execute(new String[]{url, name.getText().toString(), email.getText().toString(), mobile.getText().toString(), city.getText().toString(), state.getText().toString(), subject.getText().toString()});
    }
    ...
    private class JsonReadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("state", params[5]));
                nameValuePairs.add(new BasicNameValuePair("subject", params[6]));
