        ...
        if (null != jsonResult && !"".equals(jsonResult)) {
            ...
            try {
                ...
                for (int i = 0; i < jsonMainNode.length(); i++) {
                    ...
                    String date = Utility.convertDate(jsonChildNode.optString("createdtime"));
...
//            listView.setAdapter(adapter);
    ...
    public class OnGoingPrescriptionAdapter1 extends RecyclerView.Adapter<OnGoingPrescriptionAdapter1.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int position) {
            ...
            String dateStop = "" + prescItem.getProductDate();
            ...
            if (prescItem.getAssignedTo().equals("")) {
                viewHolder.mobile.setText("UnAssigned");
                viewHolder.mobile.setTextColor(Color.parseColor("#FFDCDCDC"));
            } else {

                viewHolder.mobile.setText(prescItem.getAssignedTo());
                viewHolder.mobile.setTextColor(Color.parseColor("#484848"));
            }
            ...
            if (prescItem.getProductStatus().equals("2")) {


                viewHolder.status.setText("In Progress");
            } else if (prescItem.getProductStatus().equals("3")) {


                viewHolder.status.setText("Closed");
            } else if (prescItem.getProductStatus().equals("4")) {


                viewHolder.status.setText("Open");
            }
            else if (prescItem.getProductStatus().equals("1")){

                viewHolder.status.setText(prescItem.getAssignedToName());
            }
            else {
